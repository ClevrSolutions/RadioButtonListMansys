define([
    ...
    return declare("RadioButtonListMansys.widget.AttrRadioButtonList", [_WidgetBase, _TemplatedMixin], {
        ...
        _addOnclickToRadiobuttonItem: function (radiobuttonNode, rbvalue) {
            ...
            this.connect(radiobuttonNode, "onclick", lang.hitch(this, function () {
                ...
                if (this.allowDeselect && this._contextObj.get(this.entity) === rbvalue) {
                    ...
                    if(manualRefresh){ 
                    	// not sure why, but for booleans, manually call updateRendering()
                    	// otherwise strange rb behavior
                			this._updateRendering();
                    }
                }
...
require(["RadioButtonListMansys/widget/AttrRadioButtonList"], function () {
    "use strict";
});
